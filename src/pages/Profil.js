                        ...
                        <Col md={5} sm={12}>
                            <Form>
                                ...
                                <Form.Group controlId="formName" className="mt-4">
                                    ...
                                    <Form.Control type="text" value="Robert" />
                                </Form.Group>
                                ...
                                <Form.Group controlId="formEmail" className="mt-4">
                                    ...
                                    <Form.Control type="email" value="adresse@mail.com" />
                                ...
                                <Form.Group controlId="formAge" className="mt-4">
                                    ...
                                    <Form.Control type="number" min={16} max={100} step={1} value={29} />
                                </Form.Group>
                                ...
                                <Form.Group controlId="formDepartement" className="mt-4">
                                    ...
                                    <Form.Control as="select">
                                        ...
                                        <option selected>80 	Somme</option>
                                ...
                                <Form.Group controlId="formCity" className="mt-4">
                                    ...
                                    <Form.Control type="text" value="Amiens" />
                                </Form.Group>
